...
-- Insert sample users (no FK dependencies)
...
-- Insert institution admin users with entity references
INSERT OR IGNORE INTO users (email, name, role, agency, entity_id, is_active) VALUES 
...
INSERT OR IGNORE INTO filings (entity_id, filing_type, status, data, risk_score, submitted_at) VALUES 
  ...
  (6, 'consumer_complaint', 'pending', '{"reporting_period":"2024-09","currency":"CAD","complaint_type":"unauthorized_fees","complaint_count":15,"total_amount":45000,"resolution_status":"investigating"}', 6.1, '2024-09-30 13:20:00'),
...
-- Insert sample cases (with proper FK references)
...
-- Update some filings with validation errors
UPDATE filings 
